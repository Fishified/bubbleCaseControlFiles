...
failfunction "$?" load fatal wallLiftSNCont

rm -r processor*
failfunction "$?" rm pass wallLiftSNCont

decomposePar
failfunction "$?" decomposePar fatal wallLiftSNCont

sbatch slurmgowallLift.sh
failfunction "$?" sbatch fatal wallLiftSNCont
